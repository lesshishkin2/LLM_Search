...
| ASSETS                                                                                                                                                                               |                  |                  |
| Current assets:                                                                                                                                                                      |                  |                  |
| Cash and cash equivalents                                                                                                                                                            | \$<br>150,365    | \$<br>205,635    |
...
| Non-current assets:                                                                                                                                                                  |                  |                  |
| Property and equipment, net of depreciation of \$105,466 and \$111,244<br>Operating lease right-of-use assets                                                                        | 71,787<br>49,687 | 73,580<br>86,034 |
...
| Total assets                                                                                                                                                                         | \$<br>1,348,553  | \$<br>1,387,149  |
|                                                                                                                                                                                      |                  |                  |
| LIABILITIES AND STOCKHOLDERS' EQUITY<br>Current liabilities:                                                                                                                         |                  |                  |
| Current portion of long-term debt                                                                                                                                                    | \$<br>37,500     | \$<br>237,500    |
...
| Total liabilities and stockholders' equity                                                                                                                                           | \$<br>1,348,553  | \$<br>1,387,149  |
...
|---------------------------------------------------------------------|-----------------|-------------------------|---------------|
|                                                                     | 2022            | 2021                    | 2020          |
| Revenue                                                             | \$<br>1,089,752 | \$<br>1,046,487         | \$<br>990,533 |
|                                                                     |                 |                         |               |
...
| Net income                                                          | \$<br>44,060    | \$<br>72,331            | \$<br>58,711  |
|                                                                     |                 |                         |               |
| Weighted-average shares outstanding:                                |                 |                         |               |
| Basic                                                               | 31,028          | 31,776                  | 32,010        |
| Diluted                                                             | 31,298          | 32,010                  | 32,278        |
| Earnings per common share:                                          |                 |                         |               |
| Basic                                                               | \$<br>1.42      | \$<br>2.28              | \$<br>1.83    |
...
| Total comprehensive income, net of tax                                            | \$<br>23,584 | \$<br>65,116            | \$<br>67,076 |
...
| Cash, cash equivalents and restricted cash, end of period                          | \$<br>389,018 | \$<br>391,902 | \$<br>354,730 |
|                                                                                    |               |               |               |
| Supplemental disclosures of cash flow information:                                 |               |               |               |
| Cash paid during the period for                                                    |               |               |               |
| Interest                                                                           | \$<br>18,314  | \$<br>12,882  | \$<br>13,681  |
| Income taxes                                                                       | 34,671        | 36,690        | 22,431        |
|                                                                                    |               |               |               |
| Reconciliation of cash, cash equivalents and restricted cash:                      |               |               |               |
| Cash and cash equivalents                                                          | \$<br>150,365 | \$<br>205,635 | \$<br>188,699 |
| Settlement and merchant reserve assets                                             | 238,653       | 186,267       | 166,031       |
| Total cash, cash equivalents and restricted cash                                   | \$<br>389,018 | \$<br>391,902 | \$<br>354,730 |
|                                                                                    |               |               |               |
...
|----------------------------|------|-----------|-----------------|---------------|
| Revenue:                   |      |           |                 |               |
| SaaS and related solutions | \$   | 956,995   | \$<br>926,290   | \$<br>880,822 |
| Software and services      |      | 87,247    | 72,818          | 63,239        |
| Maintenance                |      | 45,510    | 47,379          | 46,472        |
| Total revenue              | \$   | 1,089,752 | \$<br>1,046,487 | \$<br>990,533 |
...
|                                                                                                            | Deferred Revenue |
|------------------------------------------------------------------------------------------------------------|------------------|
| Beginning Balance, January 1, 2021                                                                         | \$<br>(69,632 )  |
...
| Other                                                                                                      | 2,808            |
| Ending Balance, December 31, 2022                                                                          | \$<br>(68,024 )  |
...
|                                     |                       | December 31, 2022 |         |    |         | December 31, 2021 |             |  |
|-------------------------------------|-----------------------|-------------------|---------|----|---------|-------------------|-------------|--|
|                                     | Assets<br>Liabilities |                   |         |    | Assets  |                   | Liabilities |  |
| Settlement assets/liabilities       | \$<br>219,368         | \$                | 218,525 | \$ | 171,505 | \$                | 170,514     |  |
| Merchant reserve assets/liabilities | 19,285                |                   | 19,285  |    | 14,762  |                   | 14,762      |  |
| Total                               | \$<br>238,653         | \$                | 237,810 | \$ | 186,267 | \$                | 185,276     |  |
|                                     |                       |                   |         |    |         |                   |             |  |
...
| Computer equipment              | 3-6          | \$<br>85,432      | \$<br>85,501      |
...
| Property and equipment, net     |              | \$<br>71,787      | \$<br>73,580      |
...
| Acquired customer contracts (1) | \$<br>165,497            | \$<br>(120,080 )            | \$<br>45,417 | \$<br>171,373               | \$<br>(114,166 )            | \$<br>57,207 |
...
|                           |                   | December 31, 2022 |              |    |        | December 31, 2021 |                   |    |              |    |        |
|---------------------------|-------------------|-------------------|--------------|----|--------|-------------------|-------------------|----|--------------|----|--------|
|                           | Gross<br>Carrying |                   | Accumulated  |    | Net    |                   | Gross<br>Carrying |    | Accumulated  |    | Net    |
|                           | Amount            |                   | Amortization |    | Amount |                   | Amount            |    | Amortization |    | Amount |
| Acquired software (2)     | \$<br>83,543      | \$                | (74,578 )    | \$ | 8,965  | \$                | 84,633            | \$ | (72,675 )    | \$ | 11,958 |
| Internal use software (3) | 89,568            |                   | (75,759 )    |    | 13,809 |                   | 97,407            |    | (79,608 )    |    | 17,799 |
| Total software            | \$<br>173,111     | \$                | (150,337 )   | \$ | 22,774 | \$                | 182,040           | \$ | (152,283 )   | \$ | 29,757 |
...
| Customer contract incentives (4) | \$<br>6,626                 | \$                          | (3,798 )  | \$ | 2,828         | \$                | 4,627                       | \$                          | (3,007 )  | \$ | 1,620         |
...
| Total customer contract costs    | \$<br>85,336                | \$                          | (30,601 ) | \$ | 54,735        | \$                | 79,028                      | \$                          | (32,410 ) | \$ | 46,618        |
...
| 2021 Term Loan, due September 2026, interest at adjusted LIBOR plus<br>applicable margin (combined rate of 6.355% at December 31, 2022)                           | \$<br>140,625        | \$<br>148,125        |
...
| Long-term debt, net of unamortized discounts                                                                                                                      | \$<br>375,469        | \$<br>137,219        |
...
|---------------------------------|--------------|-------------|-------------|---------------|---------------|
| 2021 Term Loan                  | \$<br>7,500  | \$<br>7,500 | \$<br>7,500 | \$<br>118,125 | \$<br>140,625 |
| 2021 Revolver                   | 30,000       | —           | —           | 245,000       | 275,000       |
| Total long-term debt repayments | \$<br>37,500 | \$<br>7,500 | \$<br>7,500 | \$<br>363,125 | \$<br>415,625 |
...
| Cash paid for amounts included in the measurement of<br>operating lease liabilities | \$<br>21,125 | \$<br>23,272 | \$<br>21,130 |
...
|----------------------------|--------------|--------------|--------------|
| Current:                   |              |              |              |
| Federal                    | \$<br>30,012 | \$<br>17,012 | \$<br>17,760 |
...
|                                 | 2022         | 2021         |
|---------------------------------|--------------|--------------|
| Deferred income tax assets      | \$<br>81,747 | \$<br>56,065 |
| Deferred income tax liabilities | (27,733 )    | (25,250 )    |
| Valuation allowance             | (27,925 )    | (29,983 )    |
| Net deferred income tax assets  | \$<br>26,089 | \$<br>832    |
...
| (1)<br>(2) | Incorporated by reference to the exhibit of the same number to the Registration Statement No. 333-244 on Form S-1.<br>Incorporated by reference to the exhibit of the same number to the Registrant's Quarterly Report on Form 10-Q for the period ended June<br>30, 1997. |                                                                                                                                                                      |
| (3)        | Incorporated by reference to the exhibit of the same number to the Registrant's Quarterly Report on Form 10-Q for the period ended June<br>30, 2002.                                                                                                                       |                                                                                                                                                                      |
|            |                                                                                                                                                                                                                                                                            |                                                                                                                                                                      |

(4) Incorporated by reference to the exhibit of the same number to the Registrant's Current Report on Form 8-K for the event dated November 16, 2006.

(5) Incorporated by reference to the exhibit of the same number to the Registrant's Quarterly Report on Form 10-Q for the period ended September 30, 2007.
...
Customer to ******* ****** and ******* ************************************************************************************************************************************** of Customer's then-current ******** *****]

[*** ***** will permit Customer ***** to its ******** ********** and its *** ********** ********* ****** for a period of up to **** (**) ***** from the date that each ******** **** is available for ****** (the "********* *****"), after which time the *** ******* ***** will no longer be ******** | to Customer.

Further, [****** can be stored in the same *** ****** *******. As a result, *** ***** will permit Customer ****** to its ****** for a period of up to *** (*) ***** from the date that each such ****** (the "****** (the "*************************************************************************** after which time *** ***** of ****** will no longer be ********* to Customer.

### Exhibit *-*, **** *** *******, to Schedule *, entitled *********, of the Agreement shall be amended to add b) "*****" as a new Section **, as follows:

******* . ****** provides Customer with (a) ********* ******* for Customer's ********* ******** ""**. *** ********** and ******** selected and specified by Customer. ****** will, collectively, include each of (i) ******* ********* ****** via a **** **** from Customer to CSG (the "*** ***************** ******* ****** from Customer's ********* of **** ******* ******** ******* entiled "*** ********************************************************************************************************************* Customer's ********* of **** ********* ***** nr ***************************************************************************************************************************** ****** ****** from Customer to CSG; and (b) ***** *************************************************************************************************************************** via *****].

### For purposes of clarification:

f *************************************************************************************************************************************************************************** ****** from which Customer will have the ability to ****** ******* and **** ******* and ******* ***************************************************************************** with Customer *********** stored on *** ************************* for Customer to ******* ******* ****** ****** and ****** ******* *** ***** and **** ******* (that will include **** *******) and ******* ********* ******* (for ****** ******) for ******** ********** *** *************************************************************************************************** ********** ****** ****** will be sent, as determined solely by Customer, via (i) ***** ****) and via (i) **** "+*************************************************************************************************************************************************************************** for any *********** ****** ***** will be set forth in mutually agreed Statements of Work, E-SOWs or Letters of Authorization.

f**** *********** ****** . CSG will provide Customer with access to a *** ********* ****** that allow Customer to **** ********, *******, ******, and ****** ****** ******* ***** **** **** ************************************ *********** ******* for ***************************************** and conditions for any **** *** ********************** will be set forth in mutually agreed Statements of Work, E-SOWs or Letters of Authorization.

ff*************************************************************************************************************************************************************************** *********** for *************************************************************************************************************************************************************

- As a result, Schedule [*, "**** ," Line item ** **** *** **** **** **** ***************************************************************************************************** 2. *, ********, * Subsection *, "*********************************************************************************************************************************************** entirety and replaced as follows:
32. [******* ****************************************************************************************************************************************************************

{88}------------------------------------------------

- ****," Subsection ** 3. Additionally, as a further result, Schedule *, "***," Section *., "*** * subsection * ******* (**** (**** *** ****)," is deleted and replaced as "*. *******)" and, further, those sections of subsection *. ***** ******* (** **** identified as "*" and the related "****" are deleted in their entirety and replaced, and new line item "*]" is added to the fee table, as follows:
#### III. [******* ********************************************************************************************************************************************************************
...
|                                     | Startup:                                                                                                                                                                                                                                                          |              |                                        |
|                                     | 「******* *** *******】 Fees<br>a                                                                                                                                                                                                                                   |              |                                        |
|                                     | 『关于平米关系等等来来来 关于关系等关系。                                                                                                                                                                                                                                             | 「米米米米米米米米"   | 「米米米米米"                                |
|                                     | ******************************************************************************************************************************************************************************<br>C<br>i                                                                          | 「米米米 ******* | 「米米米米米了                                |
|                                     | 「**********<br>3.                                                                                                                                                                                                                                                 | **********   | 「米米米米米了                                |
|                                     | [******* ************* Fees (Note ** )                                                                                                                                                                                                                            |              |                                        |
|                                     | (******** ********* ** ********* ****<br>发来来来 关于关系资产资产 来源来源<br>(******* ** ****** ***** ***** *****)<br>***<br>a.<br>** *** ******* ******** *** **** *******************<br>**********************<br>/*******<br>***** ******** *** *******   *** ******** **** | 「米米米米米米米     | 「米米 ****                               |
|                                     | *****************************************************************************************************************************************************************************<br>4)                                                                               | 「米米米米米米"     | 「米米 ****                               |
|                                     | ****************************************************************************   (Note S)<br>C.                                                                                                                                                                     | 「米米米米米米米     | 「米米 ****                               |
|                                     | ****************************************<br>a.                                                                                                                                                                                                                    |              | [******] [* **<br>* * ] 「******<br>. · |
|                                     | 【********* **************************** Feec (ner ******)                                                                                                                                                                                                         | 「米米米米米米"     | 「米米 米米米了                               |

Note 4. An [******** **** means *** ****** n ****** n ****** n ************************************************************************************************************** r with no more ******* than those ******* ticl () ******** (;a the ********************************************************************************************************** The page may include ****** only ******* four the ******* ****** may be used on the ********* ****** (**** and ****** to this **** ace billed at the ********* and *****

rale station in Schedule ) ***** and ******* to this **** are billed at the ** ******* ****, Customer shall be charged the

**], the following shall apply

******** **** *********** fee as reflected in *.*

- *** fee as reflected in * * *** fees
- ****** as reliected in * * * (pape), shall be date the **********************************************************************************************************************
- * as reflected in * * * (****), shall be added to the ************* ******** fees to both the ********* and applicable reflected in *.*.*.
****************
- ********* ********* *** ********
- Further, as a result and for purposes of clarification under this Amendment, the paragraph entitled "[1]****** ******" in Attachment ** 4. (*) of Exhibit *.*, "**** ******* of Schedule *, "******** ***," is hereby deleted in its entirety and any references in the Agreement to "******* ******" are hereby deleted and replaced with "******".
...
- 1. The parties agree to amend the f*** from *** **** relating to additional ********* ****** for the ****** ("***") ******* provided by CSG to Customer and documents of Work to be agreed upon and executed by the parties to implement and deploy further additional and updated **** ***** (the "****"),
- 2. Customer and CSG mutually agree Customer has requested and CSG has agreed to provide an additional [**** **** **** ************************************************************************************************************************************************************************ Customer (CSG document no. [*****) (the "**** ***************************** (C) **** ***** ******************* will include up to **** (*) **** of additional ****** *************************************************************************************************** completion of *********** and ******** of the **** ***** ******************** **** SOW.
- 3. Customer and CSG mutually agree Customer has requested and CSG has agreed to provide an additional [**** **** ************ ****** () to be implement to that certain Statement of Work to be agreed upon and executed by CSG and Customer (CSG document no. [****) (the "******** **** **** **** **** SOW') and, further, acknowledge and agree that such [************************************************************ **** will include up to **** of additional ***** **************************************************************************************************************************** and ********* of the ******************************* SOW.
- As a result, to provide for per month additional [****** 4. Schedule * " Section ******* ," Section *, "******************** ****," Subsection including **** ] thereto, shall be deleted in its entirety and replaced as follows:
...
| Description of Item/Unit of Measure                   | Frequency  | Fee          |
|-------------------------------------------------------|------------|--------------|
| 「**** *******************************   FeeS          | 「米米米 米米米米】 | 「米米米米米了      |
| 「**************」 Fees                                 |            |              |
| 「*************************** Fees **** ***** (Note *) | 「*******]  | 「*** *** **] |
| b. [******* ******] Fees (Note *)                     | 「*******]  | 「*** **】     |

*** per ***** (the "** Note 1: [ ******* support will be limited to *** ****** ***** ** support, including ****** ***, , and * Fees covers * of the receive on a superior and in the reserved many of the man of to talled based of to the reserved by and one of to with in the collection of the collection of the fill
...
NOW, THEREFORE, in consideration of the mutual covernents contained herein and for other good and valuable consideration, the recept and sufficiency of which is hereby acknowledged, CSG and Customer agree as follows:

- To delete the current fee table and associated "Notes" in Schedule *, "Fees," Section [*., "*** 1. ***********," subsection *, "******** (***** ****)," subsection **, "*** ******* *** ****
- For the entirety of [******* ****, CSG shall invoce Customer shall pay CSG the agreed-upon amount of **** ****** 2. ******* ****** (**** *** *** ******* **** **** CSC ******* *** ******* ******* *******
- Commencing as of [******* *, **** (subject to execution of this Amendment), and pursuant to the Agreement, the 3. ******** *** ******* shall be provided by CSG to Customer pursuant to the following fee table at Schedule *, "****," Section *, 44** *******," subsection ***, "********************************************************************************************************************************************* *** *****]," of the Agreement:
...
Note 33: Implementation and set up of the [*** ****** was mutually agreed upon and documented in that certain Statement of Work entitled "** Note of ******* ** **** (CSG document no. ******) executed by CSG and Customating ageccuryous of the

election of the externer were of concerner comment comment of the externer en externes were were were were were we armatel be on the best of the was and the was are are are

#### 4. Effective as of the Amendment Effective Date, CSG and Customer acknowledge and agree to the following as relates to Section [*.**(*) entitled 44.4 ************ of the Agreement (the "******* *******"), as more particularly described in the **** ) Amendment:

- CSG provided and Customer consumed the [******* ******* for ******* ***** **** and **** a) *** - and
- Customer submitted notice to CSG of its intent to terminate the [******* services on or about **** **, ****, pursuant to Note b) ** of subsection ** , "*** **************** ," to Schedule * , "****"] "

Section [*, "**********************************************"; and

- 「****** ****** **** ] services are no longer available to Customer; and c)
- Pursuant to agreement of the parties and the Agreement notwithstanding, Customer shall be obligated for payment o CSG of d) invoices for [****** ******* ****] for (i) the period during which Customer consumed the [******* services during ****** ***** **** and **** **** and, pursuant to agreement between the parties, (ii) the ***** of ******** and ****** ***]; and
- e) Pursuant to further agreement between the terms of the Agreement notwithstanding, CSG and Customer agree [****** ******* **** for the ****** ****** and ******* **** and ******* **** shall be waived and Customer shall have no obligation for payment of ****** **** therefor related to its termination of the ******* services for the ******* ***** of ******* and ********* **** and ******* ****].
...
|                                               | CHARTER COMMUNICATIONS OPERATING, LLC<br>CSG SYSTEMS, INC. ("CSG")<br>("CUSTOMER") |        |                          |  |  |
|-----------------------------------------------|------------------------------------------------------------------------------------|--------|--------------------------|--|--|
| By: Charter Communications, Inc., its Manager |                                                                                    |        |                          |  |  |
