...
| Financial liabilities - Loans | Bank loans |          | Factoring<br>payables | Lease payables |         | Other<br>financial<br>payables | Bank<br>overdrafts | Total    |
|-------------------------------|------------|----------|-----------------------|----------------|---------|--------------------------------|--------------------|----------|
|                               | C          | NC       | C                     | C              | NC      | C                              | C                  |          |
...
| Company name                     | Registered office            |     | Share capital<br>in local | Equity^ | Pro-rata<br>Equity^ | Result for<br>the period^ | % Owned | Carrying<br>amount^ | Difference |
|----------------------------------|------------------------------|-----|---------------------------|---------|---------------------|---------------------------|---------|---------------------|------------|
|                                  |                              |     | currency                  |         |                     |                           |         |                     |            |
