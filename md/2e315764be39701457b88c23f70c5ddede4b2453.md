...
| Motability<br>(national<br>Charity) | Motability, the Charity,<br>is responsible for<br>overseeing the Motability<br>Scheme. Their vision is that<br>no disabled person shall be<br>disadvantaged due to poor<br>access to transportation.<br>See page 27 for details.                                                                                                                                                                                 | •<br>We continue to work closely and collaborate with Motability on how<br>we run the Scheme and a number of initiatives.<br>•<br>We engage with them through various channels including regular<br>working groups with the teams at the Charity, the Charity's Scheme<br>Oversight Committee and at their Board of Governors' meeting.<br>•<br>We work with Motability and see real value in their input, feedback<br>and constructive challenge.<br>•<br>We are also working closely with our colleagues at Motability, to<br>ensure that electric vehicles are accessible for disabled customers. | a real difference to disabled people's lives.<br>objectives and the direction set in partnership with Motability, the Charity.          |
...
- 
- Make recommendations to the Board concerning any matters relating to the termination of a Director's contract of employment or service. • Evaluate the effectiveness of the Committee.
...
| Focus area                     | Measure                           | Bonus<br>potential | 100% Payout                                                               | 50% Payout                      | 0% Payout                   |
|--------------------------------|-----------------------------------|--------------------|---------------------------------------------------------------------------|---------------------------------|-----------------------------|
...
| £'k                    |      | Salary<br>Benefits1 |      |      | Expenses<br>reimbursed in<br>performance of<br>duties2 |      | Pension3 |      | Vesting of<br>deferred bonuses<br>and long term<br>Bonus4<br>incentives5<br>Total |      |      |      |      |      |
|------------------------|------|---------------------|------|------|--------------------------------------------------------|------|----------|------|-----------------------------------------------------------------------------------|------|------|------|------|------|
...
| Refer to page 70 (Audit<br>Committee Report), page 102      | The Group leases a fleet of cars to customers which are held as operating leases.<br>These cars are depreciated to their residual value over the life of the operating lease.                                                                                                                                          |                                                   |
| (accounting policy) and page 117<br>(financial disclosures) | The residual values are set at the start of each lease, based on a model that takes into account a<br>number of variables and assumptions. These are an estimate of the amount that would currently<br>be obtained on disposal at the end of the lease if the cars were already of the age and condition               | re-sale value of different cohorts of cars;       |
...
|                                                             | •<br>An upwards revision of residual value estimates leads to the recognition of a lower<br>depreciation charge for the year and in future years;                                                                                                                                                                      |                                                   |
|                                                             | •<br>A downwards revision of residual value estimates leads to the recognition of a higher                                                                                                                                                                                                                             | analysis that is disclosed.                       |
|                                                             | The effect of these matters is that, as part of our risk assessment, we determined that the                                                                                                                                                                                                                            | Our results                                       |
...
|                                                             | depreciation charge for the year and in future years.                                                                                                                                                                                                                                                                  |                                                   |
...
| Deferred tax assets                        | 27   | –         | –         | –         | 0.2       |
|                                            |      | 9,994.0   | 9,170.2   | 5,976.9   | 5,902.0   |
| Current assets                             |      |           |           |           |           |
...
|                                            |      | 1,886.6   | 1,397.0   | 729.5     | 342.1     |
| Total assets                               |      | 11,880.6  | 10,567.2  | 6,706.4   | 6,244.1   |
| Liabilities                                |      |           |           |           |           |
| Current liabilities                        |      |           |           |           |           |
...
| Derivative financial instruments           | 26   | –         | (0.3)     | –         | (0.3)     |
|                                            |      | (2,218.3) | (1,647.5) | (1,404.9) | (640.7)   |
| Net current liabilities                    |      | (331.7)   | (250.5)   | (675.4)   | (298.6)   |
...
|                                            |      |           |           |           |           |
| Net assets<br>Equity                       |      | 3,856.6   | 2,880.5   | 321.9     | 245.1     |
| Ordinary share capital                     | 28   | 0.1       | 0.1       | 0.1       | 0.1       |
| Hedging reserve                            |      | 52.2      | (1.0)     | 52.2      | (1.0)     |
| Restricted reserves*                       |      | 3,804.3   | 2,881.4   | 269.6     | 246.0     |
|                                            |      |           |           |           |           |
...
|                                               | Accelerated tax<br>depreciation<br>£m | Short-term<br>timing<br>differences<br>£m | Derivatives<br>£m | Accelerated<br>depreciation<br>£m | Total<br>£m |
|-----------------------------------------------|---------------------------------------|-------------------------------------------|-------------------|-----------------------------------|-------------|
|                                               |                                       |                                           |                   |                                   |             |
...
|--------------------------------------|-----------|--------|----------|------------|------------------|--------------|
|                                      | At        |        |          |            | premiums and     | At           |
|                                      | 1 October | Cash   | Foreign  | Fair value | discounts and    | 30 September |
...
|                                      |                 |         |          |            | Amortisation of               |                    |
|--------------------------------------|-----------------|---------|----------|------------|-------------------------------|--------------------|
|                                      | At<br>1 October | Cash    | Foreign  | Fair value | premiums and<br>discounts and | At<br>30 September |
|                                      | 2020            | flows   | exchange | movements  | provision charge              | 2021               |
|                                      | £m              | £m      | £m       | £m         | £m                            | £m                 |
...
|                                        | 2022                           | 2021<br>Contract fixed | 2022                 | 2021<br>Nominal |            |            |
|----------------------------------------|--------------------------------|------------------------|----------------------|-----------------|------------|------------|
|                                        | Contract fixed<br>GBP interest | GBP interest           | Nominal<br>principal | principal       | 2022       | 2021       |
...
|                                               | 2022                |              |                     |                     |              |           |
|-----------------------------------------------|---------------------|--------------|---------------------|---------------------|--------------|-----------|
|                                               | Weighted<br>average | 2022         | 2022<br>Between 1-3 | 2022<br>Between 3-5 | 2022         | 2022      |
...
|      | Weighted<br>average<br>interest rate<br>%<br>7.0<br>0.0 | 2021<br>Under 1 year<br>£m<br>(0.7)<br>– | 2021<br>Between 1-3<br>years<br>£m<br>(1.4)<br>– | 2021<br>Between 3-5<br>years<br>£m<br>(1.4)<br>– | 2021<br>Over 5 years<br>£m<br>(11.3)<br>(6.9) |
...
|------------------------------------------|---------------|--------------|-------------|-------------|--------------|-----------|
|                                          | Weighted      |              | 2021        | 2021        |              |           |
|                                          | average       | 2021         | Between 1-3 | Between 3-5 | 2021         | 2021      |
|                                          | interest rate | Under 1 year | years       | years       | Over 5 years | Total     |
|                                          | %             | £m           | £m          | £m          | £m           | £m        |
